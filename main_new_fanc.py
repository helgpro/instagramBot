...
from selenium.webdriver.common.keys import Keys# управляет кнопками клавы
...
class InstagramBot():
    ...
    def __init__(self, username, password):
        ...
        self.browser = webdriver.Chrome("../chromedriver/chromedriver")# экземпляр класа на браузере Хром
    ...
    def login(self):
        ...
        browser.get('https://www.instagram.com') # ждет пока страница полностью загрузиться
